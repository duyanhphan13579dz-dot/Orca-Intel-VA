...
const MACRO_DEFS: Omit<MacroIndicator, "series">[] = [
  { slug: "gdp-vn", name: "GDP", region: "vn", value: "7,09", change: 0.42, prev: "6,67", forecast: "6,80", unit: "%", description: "Tăng trưởng tổng sản phẩm quốc nội của Việt Nam theo năm.", source: "GSO", status: "🟢", publishedAt: "2026-06-25T00:00:00Z", syncedAt: "2026-06-28T14:15:00Z" },
  { slug: "cpi-vn", name: "CPI", region: "vn", value: "2,94", change: -0.12, prev: "3,06", forecast: "3,10", unit: "%", description: "Chỉ số giá tiêu dùng phản ánh mức lạm phát của Việt Nam.", source: "GSO", status: "🟢", publishedAt: "2026-06-25T00:00:00Z", syncedAt: "2026-06-28T14:15:00Z" },
  { slug: "lai-suat-vn", name: "Lãi suất điều hành", region: "vn", value: "4,50", change: 0, prev: "4,50", forecast: "4,50", unit: "%", description: "Lãi suất tái cấp vốn của Ngân hàng Nhà nước Việt Nam.", source: "SBV", status: "🟢", publishedAt: "2026-06-20T00:00:00Z", syncedAt: "2026-06-28T14:15:00Z" },
  { slug: "pmi-vn", name: "PMI", region: "vn", value: "50,8", change: 0.6, prev: "50,2", forecast: "51,0", unit: "điểm", description: "Chỉ số nhà quản trị mua hàng ngành sản xuất Việt Nam.", source: "S&P Global", status: "🟢", publishedAt: "2026-06-01T00:00:00Z", syncedAt: "2026-06-28T14:15:00Z" },
  { slug: "fdi-vn", name: "FDI", region: "vn", value: "25,35", change: 1.2, prev: "24,15", forecast: "26,00", unit: "tỷ USD", description: "Vốn đầu tư trực tiếp nước ngoài giải ngân lũy kế.", source: "MPI", status: "🟢", publishedAt: "2026-06-15T00:00:00Z", syncedAt: "2026-06-28T14:15:00Z" },
  { slug: "ty-gia-vn", name: "Tỷ giá trung tâm", region: "vn", value: "24.250", change: 0.08, prev: "24.230", forecast: "24.300", unit: "VND/USD", description: "Tỷ giá trung tâm do Ngân hàng Nhà nước công bố.", source: "SBV", status: "🟢", publishedAt: "2026-06-28T00:00:00Z", syncedAt: "2026-06-28T14:15:00Z" },
  { slug: "xnk-vn", name: "Xuất nhập khẩu", region: "vn", value: "786,3", change: 15.4, prev: "681,0", forecast: "800,0", unit: "tỷ USD", description: "Tổng kim ngạch xuất nhập khẩu hàng hóa của Việt Nam.", source: "GSO", status: "🟢", publishedAt: "2026-06-10T00:00:00Z", syncedAt: "2026-06-28T14:15:00Z" },
  { slug: "fed-rate", name: "Lãi suất FED", region: "world", value: "4,75", change: -0.25, prev: "5,00", forecast: "4,50", unit: "%", description: "Lãi suất quỹ liên bang của Cục Dự trữ Liên bang Mỹ (FED).", source: "FED", status: "🟢", publishedAt: "2026-06-15T00:00:00Z", syncedAt: "2026-06-28T14:15:00Z" },
  { slug: "ecb-rate", name: "Lãi suất ECB", region: "world", value: "3,40", change: -0.25, prev: "3,65", forecast: "3,15", unit: "%", description: "Lãi suất tái cấp vốn của Ngân hàng Trung ương châu Âu (ECB).", source: "ECB", status: "🟢", publishedAt: "2026-06-15T00:00:00Z", syncedAt: "2026-06-28T14:15:00Z" },
  { slug: "boj-rate", name: "Lãi suất BOJ", region: "world", value: "0,25", change: 0, prev: "0,25", forecast: "0,50", unit: "%", description: "Lãi suất chính sách của Ngân hàng Trung ương Nhật Bản (BOJ).", source: "BOJ", status: "🟢", publishedAt: "2026-06-15T00:00:00Z", syncedAt: "2026-06-28T14:15:00Z" },
  { slug: "pboc-rate", name: "Lãi suất PBOC", region: "world", value: "3,10", change: -0.25, prev: "3,35", forecast: "3,00", unit: "%", description: "Lãi suất cho vay cơ bản của Ngân hàng Nhân dân Trung Quốc (PBOC).", source: "PBOC", status: "🟢", publishedAt: "2026-06-20T00:00:00Z", syncedAt: "2026-06-28T14:15:00Z" },
  { slug: "gdp-us", name: "GDP Mỹ", region: "world", value: "2,8", change: -0.2, prev: "3,0", forecast: "2,5", unit: "%", description: "Tăng trưởng GDP hàng quý của Hoa Kỳ (đã quy năm).", source: "BEA", status: "🟢", publishedAt: "2026-06-20T00:00:00Z", syncedAt: "2026-06-28T14:15:00Z" },
  { slug: "cpi-us", name: "CPI Mỹ", region: "world", value: "2,6", change: 0.1, prev: "2,5", forecast: "2,7", unit: "%", description: "Chỉ số giá tiêu dùng của Hoa Kỳ theo năm.", source: "BLS", status: "🟢", publishedAt: "2026-06-25T00:00:00Z", syncedAt: "2026-06-28T14:15:00Z" },
  { slug: "nonfarm", name: "Nonfarm Payroll", region: "world", value: "227", change: 191, prev: "36", forecast: "200", unit: "nghìn", description: "Số việc làm phi nông nghiệp mới tạo ra tại Hoa Kỳ.", source: "BLS", status: "🟢", publishedAt: "2026-06-05T00:00:00Z", syncedAt: "2026-06-28T14:15:00Z" },
];
...
// ---------- News ----------
const NEWS_DEFS: Omit<NewsItem, "content" | "image" | "syncedAt" | "publishedAt" | "timezone" | "url">[] = [
  { slug: "vn-index-vuot-1280", title: "VN-Index bứt phá vượt mốc 1.280 điểm nhờ dòng tiền ngân hàng", summary: "Thị trường chứng khoán Việt Nam tăng mạnh phiên cuối tuần với thanh khoản cải thiện rõ rệt, nhóm ngân hàng dẫn dắt đà tăng.", source: "CafeF", category: "Trong nước", tags: ["VN-Index", "Ngân hàng"], impact: "cao" },
  { slug: "fed-ha-lai-suat", title: "FED phát tín hiệu hạ lãi suất, chứng khoán toàn cầu phản ứng tích cực", summary: "Cục Dự trữ Liên bang Mỹ để ngỏ khả năng tiếp tục nới lỏng chính sách tiền tệ trong các kỳ họp tới.", source: "Reuters", category: "Quốc tế", tags: ["FED", "Lãi suất"], impact: "cao" },
  { slug: "gia-vang-lap-dinh", title: "Giá vàng thế giới lập đỉnh mới, vàng SJC tiến sát 87 triệu đồng/lượng", summary: "Đà tăng của vàng được hỗ trợ bởi nhu cầu trú ẩn an toàn và kỳ vọng FED nới lỏng tiền tệ.", source: "Vietstock", category: "Tin hàng hóa", tags: ["Vàng", "Kim loại quý"], impact: "trung bình" },
  { slug: "fpt-loi-nhuan-ky-luc", title: "FPT báo lãi kỷ lục, mảng công nghệ nước ngoài tăng trưởng 30%", summary: "Tập đoàn FPT tiếp tục duy trì đà tăng trưởng hai chữ số nhờ chuyển đổi số và trí tuệ nhân tạo.", source: "SSI", category: "Doanh nghiệp", tags: ["FPT", "Công nghệ"], impact: "trung bình" },
  { slug: "ngan-hang-tang-tin-dung", title: "Tăng trưởng tín dụng toàn ngành ngân hàng đạt 12% so với đầu năm", summary: "Ngân hàng Nhà nước cho biết tín dụng tập trung vào sản xuất kinh doanh và các lĩnh vực ưu tiên.", source: "VCBS", category: "Tin ngân hàng", tags: ["Tín dụng", "Ngân hàng"], impact: "trung bình" },
  { slug: "bat-dong-san-phuc-hoi", title: "Thị trường bất động sản phía Nam có dấu hiệu phục hồi thanh khoản", summary: "Giao dịch căn hộ và đất nền tại TP.HCM và vùng phụ cận cải thiện trong quý gần nhất.", source: "CafeF", category: "Tin bất động sản", tags: ["Bất động sản"], impact: "thấp" },
  { slug: "bitcoin-vuot-96000", title: "Bitcoin vượt 96.000 USD, dòng tiền tổ chức tiếp tục đổ vào ETF", summary: "Tâm lý lạc quan trên thị trường tiền mã hóa được củng cố bởi dòng vốn từ các quỹ ETF giao ngay.", source: "Bloomberg", category: "Tin tiền mã hóa", tags: ["Bitcoin", "Crypto"], impact: "cao" },
  { slug: "gia-dau-giam", title: "Giá dầu WTI giảm do lo ngại nhu cầu từ Trung Quốc suy yếu", summary: "Triển vọng nhu cầu nhiên liệu kém khả quan gây áp lực lên giá dầu thô thế giới.", source: "TradingEconomics", category: "Tin hàng hóa", tags: ["Dầu thô", "Năng lượng"], impact: "trung bình" },
  { slug: "thep-hoa-phat-tang", title: "Hòa Phát tăng sản lượng thép, hưởng lợi từ đầu tư công", summary: "Nhu cầu thép xây dựng phục hồi nhờ giải ngân đầu tư công được đẩy mạnh cuối năm.", source: "Vietstock", category: "Tin hàng hóa", tags: ["Thép", "HPG"], impact: "trung bình" },
  { slug: "ai-nganh-tai-chinh", title: "AI định hình lại ngành phân tích tài chính tại Việt Nam", summary: "Các nền tảng ứng dụng trí tuệ nhân tạo giúp nhà đầu tư cá nhân tiếp cận dữ liệu chuyên sâu.", source: "CafeF", category: "AI", tags: ["AI", "Fintech"], impact: "thấp" },
];
