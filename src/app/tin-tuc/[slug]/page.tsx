      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <article className="lg:col-span-2">
          ...
          <div className="mt-3 flex items-center justify-between">
            <div className="text-sm text-muted"><span className="text-gold">{n.source}</span> • {new Date(n.publishedAt).toLocaleString("vi-VN")} <span className="text-[10px] opacity-60 ml-1">(Đồng bộ: {new Date(n.syncedAt).toLocaleTimeString("vi-VN")})</span></div>
